...
function mc(arr,send) {
    // setTimeout(function () {
        ...
        const timer = setInterval(go,15000);

    // },30000)

}
publisher(conDoor_qeName1,arr.splice(0,30),opts.__proto__,mc);
publisher(conDoor_qeName2,arr.splice(0,30),opts.__proto__,mc);
publisher(conDoor_qeName3,arr.splice(0,30),opts.__proto__,mc);
publisher(conDoor_qeName4,arr.splice(0,30),opts.__proto__,mc);
publisher(conDoor_qeName5,arr.splice(0,30),opts.__proto__,mc);
